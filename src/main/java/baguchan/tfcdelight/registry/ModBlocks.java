...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> STUFFED_PUMPKIN_BLOCK = noItemDelightRegister("stuffed_pumpkin_block", () -> new FeastTFCBlock(ExtendedProperties.of(Blocks.PUMPKIN).noDrops().randomTicks().blockEntity(TFCBlockEntities.DECAYING).serverTicks(DecayingBlockEntity::serverTick), vectorwing.farmersdelight.common.registry.ModItems.STUFFED_PUMPKIN_BLOCK, true));
